        ...
        <div className={styles['blue-card']}>
          ...
          <form onSubmit={handleRegister}>
            ...
            <label className={styles['checkbox-container']}>
              ...
              <span className={styles['checkbox-text']} style={{ fontSize: '0.8rem', lineHeight: 1.4 }}>
                {language === 'pt' && <>
                  Li e aceito os{' '}
                  <Link href="/terms" target="_blank" style={{ color: 'white', textDecoration: 'underline' }}>Termos de Uso</Link>
                  {' '}e a{' '}
                  <Link href="/privacy" target="_blank" style={{ color: 'white', textDecoration: 'underline' }}>Política de Privacidade</Link>
                  , incluindo o tratamento de dados sensíveis de saúde relacionados ao TEA (LGPD Art. 11).
                </>}
                {language === 'en' && <>
                  I have read and accept the{' '}
                  <Link href="/terms" target="_blank" style={{ color: 'white', textDecoration: 'underline' }}>Terms of Use</Link>
                  {' '}and{' '}
                  <Link href="/privacy" target="_blank" style={{ color: 'white', textDecoration: 'underline' }}>Privacy Policy</Link>
                  , including the processing of ASD-related health sensitive data (LGPD Art. 11).
                </>}
                {language === 'es' && <>
                  He leído y acepto los{' '}
                  <Link href="/terms" target="_blank" style={{ color: 'white', textDecoration: 'underline' }}>Términos de Uso</Link>
                  {' '}y la{' '}
                  <Link href="/privacy" target="_blank" style={{ color: 'white', textDecoration: 'underline' }}>Política de Privacidad</Link>
                  , incluido el tratamiento de datos sensibles de salud relacionados con el TEA (LGPD Art. 11).
                </>}
              </span>
            </label>
